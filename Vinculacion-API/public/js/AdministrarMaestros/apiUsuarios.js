        ...
        .then(data => {
            ...
            data.forEach(maestro => {
                ...
                fila.innerHTML = `
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">${maestro.claveMaestro}</td>
                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">${maestro.correoElectronico}</td>
